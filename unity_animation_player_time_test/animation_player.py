...
class AnimationPlayer:
    ...
    @timer(name="AnimationPlayer.play_frame", log_threshold=0.001)
    def play_frame(self,
                   nowtime: float,
    ...
    @timer(name="AnimationPlayer._get_seg_result", log_threshold=0.0001)
    ...
    @timer(name="AnimationPlayer.return_default")
    ...
    @timer(name="AnimationPlayer.sample_range")
